...
def instrument():
    ...
    it_water_cell = openmc.Cell(name='it-water')
    it_water_cell.fill = water
    it_water_cell.region = it_water_region

    it_th_cell = openmc.Cell(name='it-clad')
    it_th_cell.fill = SS304
    it_th_cell.region = th_region
    ...
    return openmc.Universe(name='it-univ', cells=(it_water_cell, it_cell, it_th_cell,it_gap))
